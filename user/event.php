...
<body class="page-home pd-t-0 ">
    ...
    <section id="complaint-box">
        ...
        <form action="connect_event.php" method="POST" class="complaint-form" enctype="multipart/form-data">
            <div class="complaint-form-box">
                ...
                <center>
                    ...
                    <a href="#" class="button1 active">Event</a>
                    <a href="peminjaman.php" class="button1">Peminjaman</a>
                    <a href="search_ticket.php" class="button1">Cek Status Ticket</a>
                </center>
                <br>
                <p>Sampaikan request terkait IT untuk kebutuhan event dengan mengisi form berikut</p>
                <br>
            </div>
            ...
            <div class="complaint-form-category">
                <input type="text" name="event" class="form-control" placeholder="Nama Event *" required></textarea>
                <br>
            </div>
            
            <b>Tanggal Mulai</b>
            <div class="complaint-form-category">
                <input type="date" name="tanggal_mulai" class="form-control" placeholder="Tanggal *" required></textarea>
            </div>
            <b>Tanggal Selesai</b>
            <div class="complaint-form-category">
                <input type="date" name="tanggal_selesai" class="form-control" placeholder="Tanggal *" required></textarea>
            </div>
            <b>Waktu Mulai</b>
            <div class="complaint-form-category">
                <input type="time" name="waktu_mulai" class="form-control" placeholder="Jam *" required></textarea>
            </div>
            <b>Waktu Selesai</b>
            <div class="complaint-form-category">
                <input type="time" name="waktu_selesai" class="form-control" placeholder="Jam *" required></textarea>
            </div>
            <br>
            <div class="complaint-form-category">
            ...
            <div class="complaint-form-category">
                <textarea name="detail_event" id="" rows="6" class="form-control textarea-flex autosize" placeholder="Kebutuhan Event Yang Diperlukan *" required></textarea>
            </div>
