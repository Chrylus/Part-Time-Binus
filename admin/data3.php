...
if(isset($_GET['bulan'])){
    ...
    $columnHeader = '';  
    $columnHeader = "ID" . "\t" . "Tanggal Start" . "\t" . "Tanggal Mulai" . "\t " . "Tanggal Selesai" . "\t" . "Nama" . "\t" . "Nomor Induk" . "\t" . "No Telepon" . "\t" . "Event" . "\t" . "Waktu Mulai" . "\t" . "Waktu Selesai" . "\t" . "Ruangan" . "\t" . "Detail Event" . "\t" . "Tiket" . "\t" . "Status";  
